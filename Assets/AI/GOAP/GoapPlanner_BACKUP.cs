...
//         HashSet<KeyValuePair<string,object>> state = new HashSet<KeyValuePair<string, object>>(currentState); // Copy initial state

//         foreach (KeyValuePair<string, object> change in stateChange) {
//             state.RemoveWhere(kvp => kvp.Key.Equals(change.Key)); // Remove existing entry
//             state.Add(change); // Add the updated/changed entry
//         }
